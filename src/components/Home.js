...
function Home() {
  return (
    <div>
      <h1 className="mb-4">Welcome to SecuredVote</h1>
      <p className="lead">
        SecuredVote is a secure electronic voting system that uses advanced security techniques to protect voter privacy, ensure vote integrity, and provide verifiable results.
      </p>
      <p>
